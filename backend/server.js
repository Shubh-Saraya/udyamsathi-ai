...
}catch(error){send(response,{error:error.message},400)}}).listen(process.env.PORT||3000,()=>console.log(`VyaparGuide AI core server running at http://localhost:${process.env.PORT||3000}`));
